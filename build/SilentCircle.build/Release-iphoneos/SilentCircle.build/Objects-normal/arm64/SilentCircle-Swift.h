...
#ifndef SILENTCIRCLE_SWIFT_H
#define SILENTCIRCLE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SilentCircle",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface Geofence (SWIFT_EXTENSION(SilentCircle))
...
SWIFT_CLASS("_TtC12SilentCircle15LocationManager")
...
SWIFT_CLASS("_TtC12SilentCircle23LocationSearchViewModel")
@interface LocationSearchViewModel : NSObject
...
@interface LocationSearchViewModel (SWIFT_EXTENSION(SilentCircle)) <MKLocalSearchCompleterDelegate>
...
SWIFT_CLASS("_TtC12SilentCircle19NotificationManager")
